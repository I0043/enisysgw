...
module Sys::Lib::Net::Imap
  ...
  def self.connect
    unless config = Enisys.config.imap_settings
    ...
    begin
      ...
      raise I18n.t("rumi.mail.imap_connect_fail") + " (ByeResponseError)"
    rescue Net::IMAP::NoResponseError => e
      raise I18n.t("rumi.mail.imap_connect_fail") + " (NoResponseError)"
    rescue OpenSSL::SSL::SSLError
      raise I18n.t("rumi.mail.imap_connect_fail") + " (SSLError)"
    rescue Errno::ETIMEDOUT => e
      raise I18n.t("rumi.mail.imap_connect_fail") + " (ETIMEOUT)"
    rescue Errno::ECONNRESET
      raise I18n.t("rumi.mail.imap_connect_fail") + " (ECONNRESET)"
    rescue Timeout::Error => e
      raise Sys::Lib::Net::Imap::Error.new(I18n.t("rumi.mail.late_error"))
    rescue SocketError => e
      raise I18n.t("rumi.mail.imap_connect_fail") + " (SocketError)"
    rescue Exception => e
      raise I18n.t("rumi.mail.imap_connect_fail") + " (#{e})"
    end
  end

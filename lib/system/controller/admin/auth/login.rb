...
protected
  ...
  def new_login(account, password)
    ...
    if user.groups.length != 1
      ...
      when 1,2
        ...
        flash.now[:notice] = I18n.t("rumi.account.group_error_head") + '<br />' + I18n.t("rumi.account.group_error_tail")
        return false
      end
    end
    ...
    EnisysContext[:current_user] = user
  end
  ...
  def current_user
    ...
    return EnisysContext[:current_user] if EnisysContext[:current_user]
    ...
    EnisysContext[:current_user] = _user
  end

...
module  Rumi::Gwcircular::ZipFileUtils
  # 一時ファイル格納フォルダパス
  TMP_FILE_PATH = Rails.root.join("tmp/gwcircular")
  ...
  def self.zip(filename, zip_data, options = {})
    ...
    begin
      ...
      raise I18n.t('rumi.gwcircular.message.attached_file_not_found')
    rescue Errno::ENAMETOOLONG
      raise I18n.t('rumi.gwcircular.message.file_name_too_long')
    rescue
      raise I18n.t('rumi.gwcircular.message.cannot_create_zip_file')
    end
  end

...
class Gw::Admin::UserPasswordsController < Gw::Controller::Admin::Base
  ...
  before_action :initialize_scaffold, :set_user
  ...
  def initialize_scaffold
    Page.title = t("rumi.config_settings.user_passwords.name")
    @piece_head_title = t("rumi.config_settings.user_passwords.name")
    @side = "setting"
  end
